package edu.udemy.tests;

import edu.udemy.listener.TestListener;
...
public abstract class AbstractTest {
    ...
    @BeforeTest
    public void setDriver(ITestContext ctxt) throws MalformedURLException {
        this.driver = Boolean.parseBoolean(Config.get(Constants.GRID_ENABLED))
            ? getRemoteDriver()
            : getLocalDriver();
        ctxt.setAttribute(Constants.DRIVER, driver);
    }
